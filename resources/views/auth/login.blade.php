@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('STOCK PRODUCT INFORMATION SYSTEM')])
      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-5">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('STOCK PRODUCT') }}</strong></h4>
            <div class="social-line">
            </div>
          </div>
          <div class="card-body mt-3">
            <p class="card-description text-center pt-2"></p>
